...
const AlbumChoice = (props) =>{
    ...
    useEffect(()=>{
        const fetchData = async ()=>{
            if(album !== ""){
                const url = "https://powerful-lowlands-07785.herokuapp.com/Controller/API.php";
    ...
    if(trackList.length !== 0){
        ...
        return (
            <>
                ...
                <motion.div style={{display:"flex",flexDirection:"row",width:"45%",margin:"0 auto",justifyContent:"center",backgroundColor:"rgb(22, 22, 22)",paddingTop:"3vh",paddingBottom:"3vh",borderRadius:"10px",border:"1px solid #4c0bd1"}}
